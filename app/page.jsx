      ...
      <div className={styles.aboutsec}>
        ...
        <div className={styles.acard}>
          ...
          <div className={styles.ashare}>
            <Link className={styles.sbutt}  href="https://github.com/jfmow" target="_blank" id='github' aria-label='github'><svg viewBox="0 0 16 16" class="bi bi-github" fill="currentColor" height="16" width="16" xmlns="http://www.w3.org/2000/svg">
